...
declare class View /* implements JQuery */ {
	...
	initialize(view:  View, arg: : an: ): void;
	...
	command(commandName:  any, selecto: : any, optio: s: any, hand: er: : ny): any;

	preempt(eventName:  any, handle: : an: ): any;
}
...
declare class Builder {
	...
	tag(name:  string, ...arg: : any[: ): void;

	openTag(name:  string, attribute: : an: ): void;
	...
	subview(outletName:  any, subvie: : Vie: ): void;
...
declare module "space-pen" {
	...
	class View /* implements JQueryStatic */ {
		...
		static subview(name:  any, vie: : an: ): void;

		static text(str:  string: : void;

		static tag(tagName:  any, ...arg: : any[: ): void;
		...
		command(eventName:  string, handle: : an: ): any;

		command(eventName:  string, selecto: : any, handl: r: a: y): any;

		command(eventName:  string, selecto: : any, optio: s: any, hand: er: : ny): any;
